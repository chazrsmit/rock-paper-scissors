    ...
    return(
        ...
        <>
            <div className="div-fight">
                ...
                <div className="player-choice d-flex gap-4 align-items-center col-6 col-md-4">
                ...
                <div className="house-choice d-flex gap-4 align-items-center  col-6 col-md-4">
                    <div className="title-choice">
            ...
            <div className="div-fight2">
                ...
                <div className="div-milieu2 col-5 col-sm-4 col-md-3">
                    ...
                    {!isLoading && 
                        <button className="animBtn" onClick={replay}>Play again?</button>
                    }
